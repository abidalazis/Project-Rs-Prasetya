                        ...
                        <form action="/tambah-merk/ {{ $merk->id }}" method='post'>
                            ...
                            <div class="my-3 p-3 bg-body rounded shadow-sm">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"
                                            name='nama_merk'value="{{ $merk->nama_merk }}" id="nama_merk">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="font-weight-bold col-sm-2">Nama Ruangan</label>
                                    <div class="col-sm-10">
                                        <select class="form-select" name="id_ruangan">
                                            @foreach ($data_ruangan as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ($item->id == $merk->id_ruangan) selected @endif>
                                                    {{ $item->nama_ruangan }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name='jenis'value="{{ $merk->jenis }}"
                                            id="jenis">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"
                                            name='keterangan'value="{{ $merk->keterangan }}" id="keterangan">
                                    </div>
                                </div>
                                <div class="mb-3 row">
