<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                <a class="nav-link" href="/dashboard-im">
                    <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                    Indikator Mutu
                </a>
                <div class="sb-sidenav-menu-heading">ADMIN INDIKATOR MUTU</div>
                ...
                <div class="collapse" id="collapseUang" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/tambah-cssd">CSSD</a>
                ...
                <div class="collapse" id="collapsenunjang" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/tambah-casemix">Casemix</a>
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapa" aria-expanded="false" aria-controls="collapa">
                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                    Satuan Pemeriksa Internal
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapa" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/tambah-surveilans">surveilans</a>
                        <a class="nav-link" href="/tambah-audit">Audit APD</a>
                        <a class="nav-link" href="/tambah-hand">Hand Hygiene</a>
                        <a class="nav-link" href="/tambah-surveilansok">Surveilans Kamar Operaso</a>
                        <a class="nav-link" href="/tambah-supervisi">Supervisi Unit</a>
                    </nav>
                </div>
