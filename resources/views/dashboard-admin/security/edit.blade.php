        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="/tambah-security/ {{ $security->id }}" method='post'>
                            @csrf
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"
                                            name='nama_form'value="{{ $security->nama_form }}" id="nama_form">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="link" class="col-sm-2 col-form-label">link</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name='link'value="{{ $security->link }}"
                                            id="link">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="security" class="col-sm-2 col-form-label"></label>
